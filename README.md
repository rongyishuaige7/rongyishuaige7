...
- **构建证据：** 公开范围扫描、仓库检查、7 项源码契约、ESP32 默认与背光 opt-in 编译已由 [固定 exact-HEAD Actions 构建证据](https://github.com/rongyishuaige7/esp32-ili9341-handheld-demo/actions/runs/29639425461) 验证；CI 不上传构建产物。
